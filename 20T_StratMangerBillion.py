...
def main():
    ...
    alphasExpectedReturns = GPfunctions.sma(A_trans, optimLookback).shift(1+targetFuture)
    ...
    if optimizer:
        ...
        for blockStart in range(optimtestStart, len(alphasDF.T)-optimLookback-2-targetFuture): #testStart:optimEnd
    ...
    print("targetFuture: ", targetFuture)
