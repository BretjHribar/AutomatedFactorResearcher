...
# Pruned universe: only 83 alphas pass all 9 gates
N_GRID = [5, 8, 10, 12, 15, 18, 20, 25, 30, 35, 40, 50, 60, 75, 83]
N_GRID_RANDOM = [5, 10, 15, 20, 30, 50, 75, 83]
N_RANDOM_SEEDS = 8                # 8 random subsets per N
FEES_BPS = 5.0                    # production fee
SEEDS_FOR_RANDOM = list(range(1000, 1000 + N_RANDOM_SEEDS))

OUT_DIR = ROOT / "data/aipt_results/billions_sweep_thorough_pruned"
