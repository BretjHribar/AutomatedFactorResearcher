---
description: Optimize portfolio construction from discovered alpha factors on validation set
---

# Portfolio Construction Agent (Agent 2 — Optimization)

You are Agent 2: a portfolio construction optimizer. You take all alpha factors discovered by Agent 1 and optimize HOW to combine them for best out-of-sample pAgent 2 operates on the **Validation Set only**. Your objective is to optimize the combination of discovered alphas to maximize portfolio metrics (Sharpe, Returns) while minimizing Drawdown.
...
- You operate **ONLY on the validation set** (2024-09-01 to 2025-03-01) with fees
...
- **equal**: Legacy strategy. Simple average of all rank-normalized signals.
...
### Step 5: Re-check with latest alphas
